...
// Fetch grades with joined student, course, term, and assessment_type information
$query = "
    SELECT grades.id, grades.grade, grades.assessment_type, 
...
if (isset($_GET['delete'])) {
    ...
    $_SESSION['success'] = "Grade successfully deleted.";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_grade'])) {
    ...
    $_SESSION['success'] = "Grade successfully updated.";
    header("Location: edit_delete_grades.php");
    exit;
}
?>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php foreach ($grades as $grade): ?>
                    ...
                    <!-- View Grade Modal -->
                    <div class="modal fade" id="viewGradeModal<?= $grade['id'] ?>" tabindex="-1" aria-labelledby="viewModalLabel<?= $grade['id'] ?>" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="viewModalLabel<?= $grade['id'] ?>">Grade Details</h5>
                    ...
                    <!-- Edit Grade Modal -->
                    <div class="modal fade" id="editGradeModal<?= $grade['id'] ?>" tabindex="-1" aria-labelledby="editModalLabel<?= $grade['id'] ?>" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editModalLabel<?= $grade['id'] ?>">Edit Student Marks</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form method="POST">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Enter Student Marks:</label>
